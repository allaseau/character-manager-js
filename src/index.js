...
const sectionModify = document.querySelector(".modify");
...
const buttonClick = (sectionHidden) => {
  button.addEventListener("click", sectionHidden);
};

//Fonction masquer la section index
const sectionHidden = () => {
  document.section.style = "display: none";
};
//Créer une fonction pour affiche la liste des characters
const charactersDisplay = (array) => {
  array.forEach((element) => {
    let newDiv = document.createElement("div");
    newDiv.classList.add("album", "py-5", "bg-light");
    newDiv.innerHTML = `
                  <div class="container">
                      ...
                      <div class="col">
                        <div class="card shadow-sm">
                          <img src="data:image/png;base64,${element.image}">
                            ...
                            <text x="50%" y="50%" fill="#eceeef" dy=".3em">${element.name}</text>
                          </svg>
                          ...
                          <div class="card-body">
                            ...
                            >
                              <div class="btn-group">
                                <button
                                  type="button"
                                  class="btn btn-sm btn-outline-success more"
                                 >
                                  More info
                                </button>
                                <button
